...
<td align=center colspan="5"> <font size=4 color=red > <b> ŞUBELERDEKİ ÇALIŞAN SAYISI</b></td>
<br>
	<tr>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;İD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Şube Adı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Çalışan Sayısı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","ilyass");
$baglanti->set_charset("utf8");
$sql="SELECT şubeler.şube_id,ilçe.ilçeadı,şubeler.şubeadı, COUNT(çalışan.cal_id) AS sonuc 
FROM şubeler,çalışan,ilçe
WHERE şubeler.şube_id=çalışan.şube_id AND ilçe.ilçeadı=şubeler.şubeadı
GROUP BY şubeler.şube_id";
$sorgu=mysqli_query($baglanti,$sql);
$a="TL";
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["şube_id"]."</td>";
	echo "<td align='center' bgcolor=#C5CAE9>"."<font face='Cursive'>".$sonuc["şubeadı"]."</td>";
