...
<td align=center colspan="5"> <font size=4 color=red > <b> SPORCU LİSTESİ</b></td>
<br>
	<tr>
		<th bgcolor="#003366"><i><font color=white>UKD</th>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Soyad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#003366"><i><font color=white>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Şube&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
		<th bgcolor="#003366"><i><font color=white>Üyelik Türü</th>
		<th bgcolor="#003366"><i><font color=white>Cinsiyet</th>
	</tr>
<?php 
$baglanti=mysqli_connect("localhost","root","","ilyass");
$baglanti->set_charset("utf8");
$sql="SELECT üye.üye_id, üye.ad,üye.soyad,şubeler.şubeadı,abonelik.abo_id,cinsiyet.cins_id
FROM üye,şubeler,abonelik,cinsiyet
WHERE üye.şube_id=şubeler.şube_id AND üye.abo_id = abonelik.abo_id AND üye.cins_id=cinsiyet.cins_id  
ORDER BY `üye`.`üye_id` ASC";
$sorgu=mysqli_query($baglanti,$sql);
$a="TL";
while( $sonuc=mysqli_fetch_array($sorgu,MYSQLI_ASSOC) ){
	echo '<tr>';
	echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["üye_id"]."</td>";
	echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["ad"]."</td>";	
	echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["soyad"]."</td>";
	echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["şubeadı"]."</td>";
	echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["abo_id"]."</td>";
    echo "<td align='center' bgcolor=#B3C7D6>"."<font >".$sonuc["cins_id"]."</td>";	
	echo '</tr>';
